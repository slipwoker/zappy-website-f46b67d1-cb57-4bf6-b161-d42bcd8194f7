        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            requiredFields.forEach(function(field) {
                ...
                if (!value) {
                    ...
                    const rtl = document.dir === 'rtl' || getComputedStyle(document.body).direction === 'rtl';
                    errorSpan.style.cssText = rtl
                        ? 'color: red; font-size: 0.85em; margin-right: 5px; display: block;'
                        : 'color: red; font-size: 0.85em; margin-left: 5px; display: block;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f46b67d1-cb57-4bf6-b161-d42bcd8194f7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f46b67d1-cb57-4bf6-b161-d42bcd8194f7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f46b67d1-cb57-4bf6-b161-d42bcd8194f7';
